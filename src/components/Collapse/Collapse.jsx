		...
		<div className={'collapse'}>
			...
			<div className="collapse__4">
				<div onClick={() => setToggle4(!toggle4)} className="collapse__visible">
					<h2>Sécurité</h2>
					<img className={toggle4 ? "vector rotated" : "vector"} src={Vector} alt="vector"/>
				</div>
				<div className={toggle4 ? "collapse__toggle animated" : "collapse__toggle"} style={{ height: toggle4 ? "auto" : "0px" }}>
